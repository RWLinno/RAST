...
MODEL_PARAM = {
    ...
    # GPU和计时参数 - 新增功能
    "device_id": 2,  # Use GPU 2 specifically
    "timing_mode": True,  # Enable detailed timing analysis
...
CFG = EasyDict()
# General settings
CFG.DESCRIPTION = 'Train RAST on PEMS04 dataset with timing analysis'
CFG.GPU_NUM = 1 # Number of GPUs to use (0 for CPU mode)
# Note: device_id in MODEL_PARAM will override this for specific GPU selection
# Runner
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN), "timing"])
)
...
CFG.TRAIN.DATA.BATCH_SIZE = 16  # Reduced batch size for timing analysis
